...
Vérifier `projets/` pour voir les sessions récentes et **ne pas répéter un concept des 2 dernières sessions**.
...
### Étape 1 — Récupérer le chemin absolu

**Avant de générer quoi que ce soit**, exécuter cette commande dans le terminal pour récupérer le chemin absolu du projet :

```bash
pwd
```

Stocker ce résultat comme `[CHEMIN_BASE]`. Toutes les commandes `cd` générées dans les fichiers et dans le message de lancement utiliseront ce chemin absolu — jamais un chemin relatif.

### Étape 2 — Générer les 6 exercices

Créer `projets/YYYYMMDD-projet-[concept]/` avec 6 sous-dossiers :

```
projets/YYYYMMDD-projet-fonctions/
├── 01_builtins/
│   ├── main.py
│   ├── tester.py
│   └── instructions.html
...
Les commandes dans le header utilisent le **chemin absolu complet** récupéré avec `pwd`. Noah doit pouvoir copier-coller chaque commande depuis n'importe quel endroit dans son terminal, sans jamais avoir besoin de `cd`.

```python
# ============================================================
# Exercice [N]/6 — [Titre]
# ============================================================
# 📄 Instructions : open [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/0N_[nom]/instructions.html
# 🧪 Tester       : python3 [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/0N_[nom]/tester.py
# ============================================================
```
  ...
  <section>
    ...
    <div class="commands-box">
      <div class="cmd-line">
        ...
        <code>open [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/0N_[nom]/instructions.html</code>
        <button class="copy-btn" onclick="copier(this, 'open [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/0N_[nom]/instructions.html')">⎘ copier</button>
      </div>
      <div class="cmd-line">
        <span class="label">🧪 Tester</span>
        <code>python3 [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/0N_[nom]/tester.py</code>
        <button class="copy-btn" onclick="copier(this, 'python3 [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/0N_[nom]/tester.py')">⎘ copier</button>
      </div>
    </div>
  </section>
...
Après avoir généré tous les fichiers, afficher le message suivant. Toutes les commandes utilisent les chemins absolus complets — Noah copie-colle, il ne navigue jamais dans le terminal.

```
📁  Session générée — [Concept] — 6 exercices.

Pour chaque exercice, dans l'ordre, copie-colle ces deux commandes :

  Exercice 01 :
    open [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/01_[nom]/instructions.html
    python3 [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/01_[nom]/tester.py

  Exercice 02 :
    open [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/02_[nom]/instructions.html
    python3 [CHEMIN_BASE]/projets/YYYYMMDD-projet-[concept]/02_[nom]/tester.py

  [... répéter pour 03, 04, 05, 06 ...]
